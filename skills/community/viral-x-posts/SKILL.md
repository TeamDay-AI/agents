...
name: viral-x-posts
description: >
  Write viral X/Twitter posts using 23 proven plug-and-play formulas optimized for the 2025-2026
  algorithm. Covers single tweets, threads, engagement bait, and media-enhanced formats. Use when
  the user asks to: write a tweet, draft an X post, create a thread, write viral content for Twitter/X,
  craft a hook, create engagement posts, write social media copy for X, brainstorm tweet ideas, or
  optimize existing tweets for virality. Also triggers on: "make this go viral", "tweet this",
  "X post", "Twitter thread", "write a banger tweet", "social media post".
source: https://github.com/shannhk/viral-x-posts
author: shannhk
category: marketing
tags: [x, twitter, social-media, growth, viral, content, engagement]
allowed-tools: Read
---
